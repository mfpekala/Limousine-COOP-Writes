...
namespace pgm
{
  ...
  class DeprecatedBufferedPGMIndex
  {
  public:
    struct Segment;
    struct Iterator;
...
#pragma pack(push, 1)
  ...
  template <typename K, typename V>
  struct DeprecatedBufferedPGMIndex<K, V>::Segment
  {
    friend class DeprecatedBufferedPGMIndex;
    using buffered_pgm_type = DeprecatedBufferedPGMIndex<K, V>;
  ...
  template <typename K, typename V>
  struct DeprecatedBufferedPGMIndex<K, V>::Iterator
  {
    friend class DeprecatedBufferedPGMIndex;
    using buffered_pgm_type = DeprecatedBufferedPGMIndex<K, V>;
